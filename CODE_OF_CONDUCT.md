...
We expect the official [Python Software Foundation's Code of Conduct](https://www.python.org/psf/conduct/)
to be followed by any contributors to our projects.

Like every community, the python one is full of members from around the the globe with different
ideas, skills, experiences, personalities and those shall be respected because it is what makes
every community driven, motivated, special and successful allowing the growth to happen.
...
If you need to raise a Code of Conduct report, you may do so privately by email to mail@tiagoasilva.com.
...
The code of conduct was based on exactly the same as [Encode](https://github.com/encode/.github/blob/master/CODE_OF_CONDUCT.md).
